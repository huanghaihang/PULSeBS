...
import Calendarweek from "./Calendarweek"
  ...
  constructor(props) {
    ...
    this.state={lectures:[],students:[],courses:[],selectedLecture:0,selectedCourse:0};
  ...
  getStudentList = (lectureID) => {
    ...
    axios  
      .get(`http://localhost:4001/api/lectures/:${lectureID}/students`, {})
      .then((response) => {
  ...
  getLecturesList = (lectureID) => {
    ...
    axios  
      .get(`http://localhost:4001/api/lectures/`, {
...
handleEventDrop = (info) => {
  ...
  scrolltoview=(elementId)=>{
    var input=((typeof elementId)=="string")?  elementId:"calendarWeekContainer";
...
<div className="container">
  <div className="row">
   ...
   <div className="d-flex align-content-center  flex-wrap bg-light " style={{ width: "71vw"  }} >
          { this.state.lectures.map((lecture) => <CourseItem  key = {lecture.id}   course={lecture} loadCourseData={this.scrolltoview} />) }
       </div>
       </div>
  }
    ...
    <div className="w-100" style={{height: "5vh"}}></div>
     <div  id="calendarWeekContainer" className="col">
   
     <Calendarweek  handleEventClick={this.handleEventClick} Items={this.state.lectures} />
